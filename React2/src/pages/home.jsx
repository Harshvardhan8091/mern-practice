...
const activityItems = [
	{ title: 'Profile updated', detail: 'Harshvardhan Garg changed account settings', time: '2 min ago' },
	...
	return (
		<section className="home-page">
			<div className="home-header">
				...
				<h2>Welcome back, Harshvardhan</h2>
				<p className="home-copy">
					This dashboard gives a quick snapshot of account activity, login status, and
					recent events in one clean indigo-inspired layout.
				</p>
			</div>
